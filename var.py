...
choiceraidlist = [
    ...
    {"event": "You destroyed the house dealing ** damage and gained ++ coins",
        "weight": 0.23, "xdmg": 20, "ydmg": 35, "xcoins": 30, "ycoins": 60},
...
choiceswimlist = [
    ...
    {"event": "You take a dive in the water and found a fortue worth of coins at the bottom. You gained ++ coins but didn't do any damage",
        "weight": 0.1, "xcoins": 100, "ycoins": 200},
...
choicefortlist = [
    ...
    {"event": "You completely overrun the fort and caused ** damage. You also managed to gain a total of ++ coins!",
        "weight": 0.2, "xdmg": 30, "ydmg": 47, "xcoins": 40, "ycoins": 69},
    {"event": "The fort's defenses were strong, but you were able to cause ** damage and gain ++ coins.",
        "weight": 0.2, "xdmg": 15, "ydmg": 25, "xcoins": 15, "ycoins": 27},
...
choiceransomlist = [
    ...
    {"event": "The hostages organized a counter-attack and made you take -- damage. You gained no coins.",
        "weight": 0.1, "xhlth": 20, "yhlth": 40},
    {"event": "The hostages turned out to be special trained forces of the army and managed to take you hostage instead. You paid @@ coins for your own release and took -- damage. Talk about being dumb.", "weight": 0.1, "xhlth": 20, "yhlth": 40}
]

ransomweights = [event["weight"] for event in choiceransomlist]

choicesneaklist = [    
    {"event": "You manage to sneak into the town hall and steal valuable treasures. You caused ** damage and gained ++ coins.", "weight": 0.18, "xdmg": 10, "ydmg": 15, "xcoins": 50, "ycoins": 100},    
    {"event": "The town hall's guards put up a fight, but you were able to steal ++ coins and deal ** damage.", "weight": 0.17, "xdmg": 5, "ydmg": 10, "xcoins": 75, "ycoins": 125},    
    {"event": "You successfully infiltrate the town hall and retrieve important documents, gaining ++ coins.", "weight": 0.18, "xcoins": 50, "ycoins": 100},    
    {"event": "You were able to sneak into the town hall undetected and grab valuable artifacts, earning ++ coins.", "weight": 0.12, "xcoins": 60, "ycoins": 90},    
    {"event": "You were caught by the guards while trying to sneak into the town hall, taking -- damage.", "weight": 0.2, "xhlth": 10, "yhlth": 30},
    {"event": "You were caught by the guards and had to fight your way out of the town hall, taking -- damage and losing coins.", "weight": 0.15, "xhlth": 5, "yhlth": 20}
]
...
choicefarmlist = [    
    ...
    {"event": "You raid the farm and find a hidden stash of coins, gaining a total of ++ coins.", "weight": 0.15, "xcoins": 100, "ycoins": 150},
    ...
    {"event": "The farm owner put up a fight, but you were able to steal ++ coins and deal ** damage.", "weight": 0.13, "xdmg": 5, "ydmg": 10, "xcoins": 50, "ycoins": 75},      
    ...
    {"event": "You were caught by the farmers while trying to raid the farm, taking -- damage.", "weight": 0.1, "xhlth": 5, "yhlth": 20},
    {"event": "You raid the farm but find nothing of value and leave empty handed", "weight": 0.12},
    {"event": "The farm owner was able to call for backup and you had to flee the scene, losing coins.", "weight": 0.13},
]

farmweights = [event["weight"] for event in choicefarmlist]

choicemarketlist = [
    {"event": "You successfully loot the marketplace, dealing ** damage and earning ++ coins worth of stolen goods.", "weight": 0.25, "xdmg": 30, "ydmg": 50, "xcoins": 50, "ycoins": 80},
    {"event": "You rob the cash register and steal ++ coins from inside and deal ** damage to the market.", "weight": 0.26, "xdmg": 25, "ydmg": 41, "xcoins": 100, "ycoins": 150},
    {"event": "As you loot the marketplace, a guard spots you and deals -- damage before you can escape.", "weight": 0.13, "xhlth": 5, "yhlth": 20},
    {"event": "You try to loot the marketplace but are unsuccessful and end up getting injured. You take -- damage.", "weight": 0.13, "xhlth": 5, "yhlth": 10},
    ...
    {"event": "You attempt to loot the marketplace but find nothing of value and leave empty handed.", "weight": 0.12}
]
...
choicelibrarylist = [
    ...
    {"event": "As you infiltrate the library, a guard spots you and you are forced to flee empty handed.", "weight": 0.13},
    {"event": "You try to infiltrate the library but are caught and thrown in jail, taking -- damage.", "weight": 0.13, "xhlth": 25, "yhlth": 50},
    {"event": "You attempt to infiltrate the library but trip an alarm and have to fight off security, taking -- damage.", "weight": 0.1, "xhlth": 15, "yhlth": 30},
...
choicehidelist = [
    ...
    "weight": 0.18, "xdmg": 20, "ydmg": 35},
    {"event": "You successfully evaded a dangerous situation by hiding in the well. You dealth ** damage and gained ++ coins.",
    "weight": 0.2, "xdmg": 20, "ydmg": 35, "xcoins": 30, "ycoins": 50},
...
choicesabotagelist = [
    ...
    {"event": "You found DIAMONDS in the cave and traded them for ++ coins!!!",
